...
> Estas cifras son una instantánea del feed del MITECO en la fecha indicada, no un total estable. El número de municipios con una sola estación cambia a diario según qué estaciones declaran precio, por lo que la cifra de hoy no coincidirá exactamente con la de la fecha de cálculo. La cifra de 10.814 cuenta solo estaciones que declaran gasolina 95 E5, no el total de estaciones de servicio del país, que es mayor.
